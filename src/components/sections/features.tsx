...
const SCREENS = [ScreenRadar, ScreenJobDetail, ScreenPipeline] as const;

export async function Features() {
  const t = await getTranslations("features");

  return (
    <section id="features" className="bg-e-paper py-24 lg:py-[100px] px-6 sm:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {[0, 1, 2].map((i) => {
            ...
            return (
              ...
              >
                <div className="relative px-8 pt-8 flex justify-center min-h-[280px] md:min-h-[360px] overflow-hidden bg-[radial-gradient(ellipse_at_top,rgba(58,171,131,0.06),transparent_70%),linear-gradient(180deg,#221f1b,#1c1a17)] border-b border-[var(--line)]">
                ...
                <div className="p-7 md:p-8">
                  <div className="text-xs text-e-accent font-serif italic mb-3">
                    — {t(`items.${i}.tag`)}
                  </div>
