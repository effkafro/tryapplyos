...
const STEP_SCREENS = [ScreenOnboarding, ScreenStudentResult, ScreenPipeline] as const;

export async function HowItWorksSchueler() {
  const t = await getTranslations("howSchueler");
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[0, 1, 2].map((i) => {
            ...
            return (
              ...
              >
                <div className="relative px-6 pt-7 flex justify-center min-h-[280px] md:min-h-[360px] bg-[radial-gradient(ellipse_at_top,rgba(201,165,135,0.10),transparent_70%),linear-gradient(180deg,#221f1b,#2a2620)]">
                ...
                <div className="p-7 border-t border-[var(--line)] bg-e-paper">
                  <div className="flex items-baseline gap-3 mb-2.5">
                    <span
                      className="font-serif italic text-[44px] leading-[0.9]"
                      style={{ color: "var(--color-e-accent-2)" }}
                    >
                      {i + 1}.
                    </span>
