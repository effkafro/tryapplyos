      ...
      <main className="mx-auto max-w-3xl px-6 pt-32 pb-20">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-e-text-2">
          ...
          <ul className="list-disc space-y-1 pl-6">
            <li>
              <span className="font-medium text-e-text">NEXT_LOCALE</span>
              {" — "}
              {isDE
          ...
          <ul className="list-disc space-y-1 pl-6">
            <li>
              <span className="font-medium text-e-text">Chrome:</span>
              {" "}
              {isDE
            ...
            <li>
              <span className="font-medium text-e-text">Safari:</span>
              {" "}
              {isDE
            ...
            <li>
              <span className="font-medium text-e-text">Firefox:</span>
              {" "}
              {isDE
